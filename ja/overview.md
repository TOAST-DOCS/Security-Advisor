...
## Security > Security Advisor > 概要 { #security-security-advisor-overview }
...
## 対象リソース、サポートリージョン { #target-resources-and-supported-region }
<a id="supported-range-for-selected-inspection-per-region"></a>
### 選択点検リージョン別サポート範囲 { #supported-range-for-selected-inspection-per-region }
|区分|サポートリージョン|
|---|---|
...
### 選択点検項目のプロジェクト項目点検対象リソース { #target-resources-in-project-inspection-item-for-selected-inspection-items }
|区分&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|点検項目|対象リソース|備考|
|---|---|---|---|
...
## プロジェクトメンバーのサービス利用ロール { #roles-for-project-members }
...
![画像2](../static/images/overview_jp_02.png)
