...
## Security > Security Advisor > 개요 { #security-security-advisor-overview }
...
## 점검 대상 및 서비스 리전 { #target-resources-and-supported-region }
<a id="supported-range-for-selected-inspection-per-region"></a>
### 선택 점검 리전 별 지원 범위 { #supported-range-for-selected-inspection-per-region }
|구분|지원 리전|
|---|---|
...
### 선택 점검 항목의 프로젝트 항목 점검 대상 리소스 { #target-resources-in-project-inspection-item-for-selected-inspection-items }
|구분&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|점검 항목|대상 리소스|비고|
|---|---|---|---|
...
## 프로젝트 멤버 서비스 이용 역할 { #roles-for-project-members }
...
![이미지2](../static/images/overview_02.png)
